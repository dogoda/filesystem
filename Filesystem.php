...
namespace Dogoda\Filesystem;

use Dogoda\Filesystem\Exception\FileNotFoundException;
use Dogoda\Filesystem\Exception\InvalidArgumentException;
use Dogoda\Filesystem\Exception\IOException;

/**
 * Provides basic utility to manipulate the file system.
 *
 * @package Dogoda\Filesystem\Filesystem
 * @author Emmnauel [netesy] Olisah
 * @copyright 2020 Feley Framework
 * @version 0.0.5
 */
class Filesystem
{
